...
url_dict = {'Teknoloji': 'https://flipboard.com/section/teknoloji-a0isdrb4bs8bb7n1','Spor':'https://flipboard.com/section/spor-d7ilibva0mpg02ec',
            'Ekonomi':'https://flipboard.com/section/ekonomi-2j5aogjl2t55j3ss','Sağlık':'https://flipboard.com/section/sa-l-k-q9p4fs08v5kbhg6g','Oyun': 'https://flipboard.com/@gamercomtr'}



for i,j in url_dict.items():
    d = AllNews(url=j,category=i)
    d.VeriBelirle()
